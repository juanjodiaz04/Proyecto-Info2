...
Q_CONSTINIT static const qt_meta_stringdata_CLASSenemyENDCLASS_t qt_meta_stringdata_CLASSenemyENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(6, 12),  // "delete_tammy"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 4),  // "tipo"
        QT_MOC_LITERAL(25, 9),  // "movetammy"
        QT_MOC_LITERAL(35, 9),  // "deadtammy"
        QT_MOC_LITERAL(45, 11)   // "movetickets"
    },
    "enemy",
    "delete_tammy",
    "",
...
void enemy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->delete_tammy((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->movetammy(); break;
        case 2: _t->deadtammy(); break;
        case 3: _t->movetickets(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &enemy::delete_tammy; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void enemy::delete_tammy(int _t1)
{
